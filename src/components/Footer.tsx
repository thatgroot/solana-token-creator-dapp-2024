                ...
                <form onSubmit={handleSubmit} className="mb-6 space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <button
                      ...
                      className="hover:bg-primary-hover hover:border-primary-hover border-primary bg-primary-hover border-primary bg-primary end-[6px] absolute top-[6px] inline-flex h-9 items-center justify-center gap-2 rounder-md px-6 text-white transition-all"
                    >
                      Subscribe
                    </button>
                  </div>
